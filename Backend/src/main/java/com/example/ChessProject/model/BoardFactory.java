...
public class BoardFactory {
    public static Board createBoard(){
        ...
        board.setPiece(new Position(0, 4), new Queen(Color.BLACK, new Position(0, 3)));
        board.setPiece(new Position(0, 3), new King(Color.BLACK, new Position(0, 4)));
        ...
        board.setPiece(new Position(7, 4), new Queen(Color.WHITE, new Position(7, 3)));
        board.setPiece(new Position(7, 3), new King(Color.WHITE, new Position(7, 4)));
